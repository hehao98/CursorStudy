...
# panel_data <- panel_data[panel_data$commits >= 10] # only include very active repos
...
outcome_variables <- c(
    ...
    "log(comment_lines_density + 1)" = "Comment Lines Density",
    "log(duplicated_lines_density + 1)" = "Duplicated Lines",
