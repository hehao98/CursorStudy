...
```{r raw_event_plots, fig.width=10.5, fig.height=4}
...
combined_plot <- plot_grid(plotlist = plot_list, ncol = 4, align = "hv", axis = "tblr")
...
ggsave("../plots/descriptive_pre_post.pdf",
  plot = combined_plot, width = 10.5, height = 4, device = CairoPDF, family = "DejaVu Sans")
```
