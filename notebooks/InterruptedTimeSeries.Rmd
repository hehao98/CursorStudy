...
# Create lists of related models for summary tables
productivity_models <- list(
...
# Generate model summary tables using modelsummary
modelsummary(
    productivity_models,
    title = "Repository-Level Productivity Models",
    stars = TRUE,
...
modelsummary(
    quality_models,
    title = "Repository-Level Code Quality Models",
    stars = TRUE,
    gof_map = c("nobs", "r.squared", "adj.r.squared"),
    coef_map = cm,
    output = "html"
...
modelsummary(
    structure_models,
    title = "Repository-Level Code Structure Models",
    stars = TRUE,
    gof_map = c("nobs", "r.squared", "adj.r.squared"),
    coef_map = cm,
    output = "html"
